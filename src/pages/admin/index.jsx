  ...
  return (
    <div className="flex h-full min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
      <aside className="w-64 bg-white dark:bg-gray-800 shadow-md hidden md:block">
        <div className="p-4">
          <h2 className="text-2xl font-bold mb-4 text-gray-800 dark:text-gray-100">Admin View</h2>
          <nav>
          ...
          <div className="flex justify-between items-center mb-8 flex-wrap gap-4">
            ...
            <div className="flex items-center space-x-4">
              ...
              <h2 className="text-2xl font-semibold text-gray-700 dark:text-gray-300">
                Welcome, <span className="text-violet-700 dark:text-violet-400">{user?.userName}</span>
              </h2>
            </div>
          </div>
